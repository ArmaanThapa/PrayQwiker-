...
function resendVerificationCode(val) {
	...
	function submitResendVerificationCode(){
		...
		xhttp.open("GET", "<%=request.getContextPath()%>/ajaxResendVerificationCode?email=" + emailid, true);
		xhttp.send();
	}
//------------------------------------------
...
<div align="center" style="color: red;background-color: maroon; font-size: medium; border-width: thin;">${firstnameError}${lastnameError}${emailError}${mobileError}${passwordError}${confirmpasswordError}</div>
 --%>
 <%-- <form:form modelAttribute="resendCode" method="post"> --%>
			...
			<div class="col-sm-3">
				...
				<div class="brands_products">
					...
					<div class="brands-name">
						...
						<!-- <li><a href="#"> <span class="pull-right">(50)</span>Levi's®
							</a></li>
							<li><a href="#"> <span class="pull-right">(56)</span>The
									Kooples
							</a></li>
							<li><a href="#"> <span class="pull-right">(27)</span>Stutterheim
							</a></li>
							<li><a href="#"> <span class="pull-right">(32)</span>Under
									Armour
							</a></li>
							<li><a href="#"> <span class="pull-right">(5)</span>Paige
									Denim
							</a></li>
							<li><a href="#"> <span class="pull-right">(9)</span>
									Zegna
							</a></li>
							<li><a href="#"> <span class="pull-right">(4)</span>FRAME
							</a></li> -->
						</ul>
						</c:forEach>
					</div>
							...
							<div class="col-sm-3">
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											<img
												src="<%=request.getContextPath()%>/resources/images/home/gallery1.jpg"
												alt="" />
											<h2>
							...
							<div class="col-sm-3">
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											<img
												src="<%=request.getContextPath()%>/resources/images/home/gallery2.jpg"
												alt="" />
											<h2>
												<i class="fa fa-inr"></i> 100
											</h2>
							...
							<div class="col-sm-3">
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											<img
												src="<%=request.getContextPath()%>/resources/images/home/gallery3.jpg"
												alt="" />
											<h2>
												<i class="fa fa-inr"></i> 100
											</h2>
							...
							<div class="col-sm-3">
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											<img
												src="<%=request.getContextPath()%>/resources/images/home/gallery4.jpg"
												alt="" />
											<h2>
												<i class="fa fa-inr"></i> 100
											</h2>
...
<div id="verifycodeModal" class="modal fade" role="dialog">
					...
					<form action="<%=request.getContextPath()%>/verifyCode">
						...
						<input type="hidden" name="${_csrf.parameterName}"
							...
							<!-- <h6><a href="#" data-toggle="modal"
								data-target="#resendVerificationCodeModal"> Resend Verification Code</a></h6>  -->
							<input type="submit"
	...
	<div id="resendVerificationCodeModal" class="modal fade" role="dialog">
		<div class="modal-dialog modal-sm">
			...
			<div class="modal-content">
				<div class="modal-body text-center">
				<%-- <%=request.getContextPath()%>/resendVerificationCode --%>
